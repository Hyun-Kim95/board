		...
		<div class="w-full">
			...
			<div class="flex flex-row mt-2 py-3">
				<div class="flex flex-col mb-2 mt-1">
					<div class="text-gray-600 font-semibold">작성자 :
			...
			<div class="text-gray-600 font-semibold text-lg mb-2">제목 :
				${article.title}</div>
			<div class="text-gray-500 font-thin text-sm mb-6 box-border">${article.body}</div>
		</div>
	</div>
</section>
